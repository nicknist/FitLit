...
describe('Climb', () => {
  ...
  it('should be able to return an array of weekly climb data', () => {
    expect(climb2.returnWeeklyClimb(1, "2019/06/22")).to.deep.equal([10, 33, 32, 10, 20, 23, 23]);
  });
